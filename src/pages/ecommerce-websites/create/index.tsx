...
import { createEcommerceWebsite } from 'apiSdk/ecommerce-websites';
...
function EcommerceWebsiteCreatePage() {
  ...
  const handleSubmit = async (values: EcommerceWebsiteInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createEcommerceWebsite(values);
      resetForm();
